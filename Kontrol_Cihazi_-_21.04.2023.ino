...
void gpskonum()//KONUM İÇİN EKLENDİ
{
  ...
  if ((msggelen.indexOf("+CGNSINF: 1,1,") > -1))
  {
   ...
   Serial.println(latitude);                                                delay(onn);
 ...
 //    delay(1000);
    ...
    //  delay(2000);
      ...
      {
      printSerialData();
      myGsm.print("Konum: ");myGsm.println( konum);
      }
...
myGsm.print("Doluluk:");myGsm.println(doluluk);
myGsm.print("Voltaj:");myGsm.println(voltaj);
myGsm.print("Sıcaklık:");myGsm.println(sicaklik);
myGsm.print("Kapı durum:");myGsm.println(kapidurum);
myGsm.print("Kapak durum:" );myGsm.println(kapakdurum);
myGsm.print("İ:");myGsm.println(i);
myGsm.print("Konum: ");myGsm.println( konum);
...
if(sayacdort >=200){   // 2 sn bir serial den yazı yazar.
 Serial.print("voltaj = ");Serial.println(voltaj);Serial.print("mesafe = ");Serial.println(c);Serial.print("sicaklik = ");Serial.println(sicaklik);Serial.print("kapidurum = ");Serial.println(kapidurum);Serial.print("kapakdurum = ");Serial.println(kapakdurum);
Serial.print("lcdsayaci = ");Serial.println(lcdsayaci);Serial.print("sayaciki = ");Serial.println(sayaciki); Serial.print("doluluk = ");Serial.println(doluluk);Serial.print("i = ");Serial.println(i);Serial.print("presdoluluk = ");Serial.println(presdoluluk);
Serial.print("presdoluluk = ");Serial.println(presdoluluk);
if(i == 1){
